...
export const MOCK_PARTENAIRES = [
  { id: 'p1', prenom: 'Diane',    nom: 'Mbaye',    ville: 'Longueuil',      lat: 45.5243, lng: -73.4934, note: 4.9, nb_avis: 87, specialites: ['Tresses', 'Knotless'], disponible: true,  photo: null, code: 'KADIO-DIANE-001',
    adresse: '615 rue Antoinette-Robidoux, Longueuil, QC J4H 1M3',
    bio: `Coiffeuse certifiée spécialisée en knotless et tresses depuis 5 ans. Passionnée, minutieuse et toujours à l'écoute.`,
    langues: ['Français', 'Wolof', 'Anglais'],
    modes_travail: ['au_salon', 'chez_coiffeur', 'deplacement_voiture'],
    services_rendus: 342, temps_reponse: '< 2h', niveau: 'Certifié',
    avis: [
      { client: 'Aminata C.', note: 5, texte: 'Knotless parfaites, très douce avec mes cheveux fragiles.', date: '2026-03-20' },
      { client: 'Mariama S.', note: 5, texte: 'Toujours ponctuelle et le résultat est impeccable.', date: '2026-03-14' },
      { client: 'Inès B.',    note: 4, texte: 'Très bon travail, juste un peu long cette fois.', date: '2026-03-08' },
    ],
  },
  { id: 'p2', prenom: 'Fatou',    nom: 'Konaté',   ville: 'Saint-Hubert',   lat: 45.5005, lng: -73.4189, note: 4.7, nb_avis: 54, specialites: ['Locs', 'Knotless'],   disponible: true,  photo: null, code: 'KADIO-FATOU-002',
    adresse: '3200 boul. Cousineau, Saint-Hubert, QC J3Y 8Z6',
    bio: 'Experte en locs et knotless. J\'accompagne mes clients du démarrage à l\'entretien longue durée.',
    langues: ['Français', 'Bambara'],
    modes_travail: ['chez_coiffeur', 'deplacement_transport'],
    services_rendus: 198, temps_reponse: '< 1h', niveau: 'Élite',
    avis: [
      { client: 'Kevin M.', note: 5, texte: 'Mes locs n\'ont jamais été aussi belles. Merci Fatou !', date: '2026-03-18' },
      { client: 'Omar B.',  note: 5, texte: 'Très professionnelle, elle connaît son métier.', date: '2026-03-10' },
    ],
  },
  { id: 'p3', prenom: 'Sandra',   nom: 'Pierre',   ville: 'Montréal-Nord',  lat: 45.5991, lng: -73.6199, note: 4.8, nb_avis: 63, specialites: ['Tresses', 'Coupes'],   disponible: false, photo: null, code: 'KADIO-SANDRA-003',
    adresse: '4900 boul. Henri-Bourassa E, Montréal-Nord, QC H1G 2T2',
    bio: 'Tresseuse professionnelle avec 8 ans d\'expérience. Spécialisée en cornrows et tresses protectrices.',
    langues: ['Français', 'Créole haïtien', 'Anglais'],
    modes_travail: ['au_salon', 'chez_coiffeur', 'deplacement_voiture', 'mode_mixte'],
    services_rendus: 276, temps_reponse: '< 3h', niveau: 'Certifié',
    avis: [
      { client: 'Léa D.',       note: 5, texte: 'Sandra fait les plus belles cornrows que j\'ai vues.', date: '2026-03-12' },
      { client: 'Christelle M.', note: 5, texte: 'Très patiente et résultat superbe.', date: '2026-03-05' },
    ],
  },
  { id: 'p4', prenom: 'Aminata',  nom: 'Coulibaly',ville: 'Laval',          lat: 45.6066, lng: -73.7124, note: 4.6, nb_avis: 38, specialites: ['Barbier', 'Coupes'],   disponible: true,  photo: null, code: 'KADIO-AMINA-004',
    adresse: '1200 boul. Le Corbusier, Laval, QC H7S 2K1',
    bio: 'Barbière certifiée. Fade, dégradé, texturizer — je maîtrise toutes les coupes tendance pour hommes.',
    langues: ['Français', 'Malinké'],
    modes_travail: ['au_salon', 'deplacement_voiture', 'deplacement_transport'],
    services_rendus: 145, temps_reponse: '< 2h', niveau: 'Partenaire',
    avis: [
      { client: 'David P.',  note: 5, texte: 'Meilleur fade que j\'ai eu à Laval. Je reviens chaque mois.', date: '2026-03-16' },
      { client: 'Patrick L.', note: 4, texte: 'Bonne coupe, service rapide.', date: '2026-03-02' },
    ],
  },
  { id: 'p5', prenom: 'Rachel',   nom: 'Ndoye',    ville: 'Brossard',       lat: 45.4579, lng: -73.4584, note: 5.0, nb_avis: 72, specialites: ['Knotless', 'Tresses'], disponible: true,  photo: null, code: 'KADIO-RACHEL-005',
    adresse: '8080 boul. Taschereau, Brossard, QC J4X 1C2',
    bio: 'Passionnée de coiffure afro depuis toujours. Knotless, tresses et styles protecteurs sont ma spécialité.',
    langues: ['Français', 'Wolof', 'Anglais'],
    modes_travail: ['chez_coiffeur', 'deplacement_voiture', 'mode_mixte'],
    services_rendus: 310, temps_reponse: '< 1h', niveau: 'Ambassadeur',
    avis: [
      { client: 'Aminata C.', note: 5, texte: 'Rachel est la meilleure ! Mes knotless durent 8 semaines.', date: '2026-03-22' },
      { client: 'Sophie K.',  note: 5, texte: 'Service exceptionnel, très douce et rapide.', date: '2026-03-15' },
      { client: 'Inès B.',    note: 5, texte: 'Mon abonnement Kadio + Rachel = la combo parfaite.', date: '2026-03-01' },
    ],
  },
  { id: 'p6', prenom: 'Marcus',   nom: 'Durand',   ville: 'Longueuil',      lat: 45.5405, lng: -73.4960, note: 4.5, nb_avis: 41, specialites: ['Barbier', 'Locs'],     disponible: true,  photo: null, code: 'KADIO-MARCUS-006',
    adresse: '500 ch. de Chambly, Longueuil, QC J4H 3L8',
    bio: 'Barbier et locticien. Je combine les coupes tendance avec l\'entretien de locs pour un style complet.',
    langues: ['Français', 'Anglais', 'Espagnol'],
    modes_travail: ['au_salon', 'chez_coiffeur', 'deplacement_voiture', 'deplacement_transport', 'mode_mixte'],
    services_rendus: 167, temps_reponse: '< 2h', niveau: 'Certifié',
    avis: [
      { client: 'Jean-Baptiste K.', note: 5, texte: 'Marcus gère autant le fade que les locs. Rare et précieux.', date: '2026-03-19' },
      { client: 'Kevin M.',         note: 4, texte: 'Bon barbier, ambiance relax.', date: '2026-03-11' },
    ],
  },
]
